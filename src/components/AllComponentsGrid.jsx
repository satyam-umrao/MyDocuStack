    ...
    <section className="section-tile-light" id="all-components-section">
      <div className="container">
        ...
        <div className="section-header-apple">
          <h2 className="section-title-apple">All Components & APIs</h2>
          <p className="section-subtext-apple">
            Complete interactive gallery of React Native core components and
            native device APIs. Click any card to inspect dedicated
            documentation.
          </p>
        </div>
